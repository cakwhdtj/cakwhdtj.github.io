...
class Main_oldVersion extends Component {
    componentDidMount() {
    ...
    constructor(props) {
        ...
        this.state = {
            subheadings: [
                ...
                { id: 9, title: 'Rotation', desc: 'Rotation_UI' },
            ],
            api: [
                { id: 1, title: 'API', desc: 'API' }
            ],
    ...
    render() {
        const Content = [this.state.api, this.state.imageSlide, this.state.bannerSlide, this.state.scrollUI, this.state.popup, this.state.dragUI, this.state.navUI, this.state.mobileUI, this.state.rotationUI]
        return (
            <main className="Main">
...
export default Main_oldVersion;